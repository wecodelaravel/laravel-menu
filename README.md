...
```php
composer require wecodelaravel/laravel-menu
```
...
```php
Wecodelaravel\Menu\MenuServiceProvider::class,
```

3. add facade in the file config/app.php (optional on laravel 5.5)

```php
'Menu' => Wecodelaravel\Menu\Facades\Menu::class,
```

4. Run publish

```php
php artisan vendor:publish --provider="Wecodelaravel\Menu\MenuServiceProvider"
```
